      ...
      <div className="flex flex-col md:flex-row w-full gap-10">
        <div className="w-full md:w-[50%] flex flex-col gap-5 justify-center">
          ...
          <p className="text-gray-500">
            O GourmetOn foi desenvolvido pensando em oferecer a melhor
            experiência possível para os amantes de gastronomia. Com uma
            interface intuitiva e um processo de pedido simplificado, você pode
            receber sua comida favorita em poucos minutos.
          </p>
          <p className="text-gray-500">
