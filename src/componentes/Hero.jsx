export default function Hero() {
  return (
    <section className="w-full py-20 bg-[#fff9f6] flex px-20 gap-10">
      <div className="w-[50%] flex flex-col gap-5 justify-center">
        ...
        <button className="bg-orange-500 text-white py-2 px-4 rounded-[20px] w-[200px] font-bold shadow-orange-500/50 shadow-lg hover:bg-orange-600 cursor-pointer">
          Baixar Agora
        </button>
      </div>
